#' @title CategorizeV2 input data by comparing the AIC values of the three fitted models.
#'
...
#' @param view_details Logical to chose if we want to see details or not. Default is "FALSE"
#'
#'
...
#'
#'outputCluster=categorizeV2(parameterVectorLinear=linearModel,
...
categorizeV2<-
           ...
           view_details=FALSE)
  {
    ...
    if(view_details){str(decisionList)}
...
#'dataInput=data.frame(intensity=intensity,time=time)
#'normalizedInput = sicegar::normalizeData(dataInput,dataInputName="batch_01_21_2016_samp007623")
#'isThis_nosignal = sicegar::pre_categorize(normalizeInput = normalizeInput)
#'
#'
#'
...
#'
#'dataInput=data.frame(intensity=intensity,time=time)
#'normalizeInput = sicegar::normalizeData(dataInput,dataInputName="batch_01_21_2016_samp007623")
#'isThis_nosignal = sicegar::pre_categorize(normalizeInput = normalizeInput)
#'
