---
title: Figure generation tools
author: "Umut Caglar, Claus O. Wilke"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Figure generation tools}
...
sicegar::figureModelCurves(dataInput = fitObj_sm$normalizedInput)

# double-sigmoidal raw data only
sicegar::figureModelCurves(dataInput = fitObj_dsm$normalizedInput)
```
