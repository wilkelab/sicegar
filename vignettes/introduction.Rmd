...
dataInputSigmoidal <- data.frame(intensity, time)
```
...
fitObj_sm <- sicegar::fitAndCategorize(dataInput = dataInputSigmoidal)
fitObj_dsm <- sicegar::fitAndCategorize(dataInput = dataInputDoubleSigmoidal)
```
